...
HCTX initTablet(HWND hWnd)
{
	...
	LOGCONTEXTA     lcMine;           /* The context of the tablet */
                                   ...
                                   WPARAM wParam, LPARAM lParam)
{
    ...
    switch (uMsg)
    {
		...
		case WT_PACKET:
		{
			...
			{
				getWT.x = (UINT)pkt.pkX;
				getWT.y = (UINT)pkt.pkY;
				getWT.cursor = pkt.pkCursor;
				getWT.press = pkt.pkNormalPressure;
				getWT.orient = pkt.pkOrientation;
			}
			break;
		}
